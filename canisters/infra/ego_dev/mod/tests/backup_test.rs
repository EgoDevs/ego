...
fn test_export() {
  ...
  let result = record_export("ego_dev_apps".to_string(), 0, 1000, 0).expect("record not founded");
  ...
  let result = record_export("files".to_string(), 0, 1000, 0).expect("record not founded");
  ...
  let result = record_export("developers".to_string(), 0, 1000, 0).expect("record not founded");
  ...
  let result = record_export("app_versions".to_string(), 0, 1000, 0).expect("record not founded");
