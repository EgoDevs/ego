...
impl From<EgoStoreErr> for EgoError {
  fn from(e: EgoStoreErr) -> Self {
    match e {
      ...
      EgoStoreErr::WalletProviderExists => EgoError::new(3011, "ego-store: wallet provider exists"),
      EgoStoreErr::WalletProviderNotExists => EgoError::new(3012, "ego-store: wallet provider not exists"),
