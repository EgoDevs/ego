...
export type Result_13 = { 'Ok' : [] | [Array<[Principal, string]>] } |
  { 'Err' : string };
export type Result_14 = { 'Ok' : Array<Developer> } |
  { 'Err' : EgoError };
...
export type Result_4 = { 'Ok' : bigint } |
  { 'Err' : string };
export type Result_5 = { 'Ok' : EgoDevApp } |
  { 'Err' : EgoError };
export type Result_6 = { 'Ok' : Developer } |
  { 'Err' : EgoError };
...
export interface _SERVICE {
  ...
  'balance_get' : ActorMethod<[], Result_4>,
  'developer_app_get' : ActorMethod<[string], Result_5>,
  'developer_app_list' : ActorMethod<[], Result_3>,
  'developer_app_new' : ActorMethod<[AppMainNewRequest], Result_5>,
  'developer_main_get' : ActorMethod<[], Result_6>,
  'developer_main_register' : ActorMethod<[string], Result_6>,
  ...
  'ego_cycle_threshold_get' : ActorMethod<[], Result_4>,
  ...
  'ego_runtime_cycle_threshold_get' : ActorMethod<[], Result_4>,
  ...
  'user_main_list' : ActorMethod<[string], Result_14>,
