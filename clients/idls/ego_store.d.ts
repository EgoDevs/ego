...
export type Result_17 = { 'Ok' : bigint } |
  { 'Err' : EgoError };
export type Result_18 = { 'Ok' : WalletCycleChargeResponse } |
  { 'Err' : EgoError };
export type Result_19 = { 'Ok' : Array<CashFlow> } |
  { 'Err' : EgoError };
export type Result_2 = { 'Ok' : Array<UserApp> } |
  { 'Err' : EgoError };
export type Result_20 = { 'Ok' : Principal } |
  { 'Err' : EgoError };
...
export type Result_5 = { 'Ok' : Array<Order> } |
  { 'Err' : EgoError };
export type Result_6 = { 'Ok' : Array<WalletProvider> } |
  { 'Err' : EgoError };
export type Result_7 = { 'Ok' : App } |
  { 'Err' : EgoError };
export type Result_8 = { 'Ok' : Array<App> } |
  { 'Err' : EgoError };
...
export interface _SERVICE {
  ...
  'admin_wallet_provider_add' : ActorMethod<
    ...
    Result_3
  >,
  'admin_wallet_provider_list' : ActorMethod<[], Result_6>,
  'app_main_get' : ActorMethod<[string], Result_7>,
  'app_main_list' : ActorMethod<[], Result_8>,
  'app_main_release' : ActorMethod<[EgoStoreApp], Result_4>,
  'balance_get' : ActorMethod<[], Result_9>,
  'ego_canister_add' : ActorMethod<[string, Principal], Result_10>,
  'ego_canister_list' : ActorMethod<[], Result_11>,
  'ego_canister_remove' : ActorMethod<[string, Principal], Result_10>,
  'ego_controller_add' : ActorMethod<[Principal], Result_10>,
  'ego_controller_remove' : ActorMethod<[Principal], Result_10>,
  'ego_controller_set' : ActorMethod<[Array<Principal>], Result_10>,
  'ego_cycle_check' : ActorMethod<[], Result_10>,
  'ego_cycle_estimate_set' : ActorMethod<[bigint], Result_10>,
  'ego_cycle_history' : ActorMethod<[], Result_12>,
  'ego_cycle_info' : ActorMethod<[], Result_13>,
  'ego_cycle_recharge' : ActorMethod<[bigint], Result_10>,
  ...
  'ego_op_add' : ActorMethod<[Principal], Result_10>,
  'ego_op_list' : ActorMethod<[], Result_16>,
  'ego_op_remove' : ActorMethod<[Principal], Result_10>,
  'ego_owner_add' : ActorMethod<[Principal], Result_10>,
  'ego_owner_add_with_name' : ActorMethod<[string, Principal], Result_10>,
  'ego_owner_list' : ActorMethod<[], Result_16>,
  'ego_owner_remove' : ActorMethod<[Principal], Result_10>,
  'ego_owner_set' : ActorMethod<[Array<Principal>], Result_10>,
  'ego_runtime_cycle_threshold_get' : ActorMethod<[], Result_9>,
  'ego_user_add' : ActorMethod<[Principal], Result_10>,
  'ego_user_list' : ActorMethod<[], Result_16>,
  'ego_user_remove' : ActorMethod<[Principal], Result_10>,
  'ego_user_set' : ActorMethod<[Array<Principal>], Result_10>,
  ...
  'wallet_cycle_balance' : ActorMethod<[], Result_17>,
  'wallet_cycle_charge' : ActorMethod<[WalletCycleChargeRequest], Result_18>,
  'wallet_cycle_list' : ActorMethod<[], Result_19>,
  'wallet_main_new' : ActorMethod<[Principal], Result_1>,
  'wallet_main_register' : ActorMethod<[Principal], Result_20>,
  'wallet_order_list' : ActorMethod<[], Result_5>,
  'wallet_order_new' : ActorMethod<[number], Result_21>,
  'wallet_order_notify' : ActorMethod<[bigint], Result_4>,
  'wallet_tenant_get' : ActorMethod<[], Result_20>,
}
