...
export type Result_8 = { 'Ok' : null } |
  { 'Err' : EgoError };
export type Result_9 = { 'Ok' : Array<Payment> } |
  { 'Err' : EgoError };
...
export interface _SERVICE {
  ...
  'ledger_main_init' : ActorMethod<[LedgerMainInitRequest], Result_8>,
  'ledger_payment_add' : ActorMethod<[LedgerPaymentAddRequest], Result_8>,
  'ledger_payment_list' : ActorMethod<[], Result_9>,
