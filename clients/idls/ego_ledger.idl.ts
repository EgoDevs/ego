export const idlFactory = ({ IDL }) => {
  ...
  const Result_8 = IDL.Variant({ 'Ok' : IDL.Null, 'Err' : EgoError });
  ...
  const Result_9 = IDL.Variant({ 'Ok' : IDL.Vec(Payment), 'Err' : EgoError });
  return IDL.Service({
    ...
    'ledger_main_init' : IDL.Func([LedgerMainInitRequest], [Result_8], []),
    'ledger_payment_add' : IDL.Func([LedgerPaymentAddRequest], [Result_8], []),
    'ledger_payment_list' : IDL.Func([], [Result_9], []),
